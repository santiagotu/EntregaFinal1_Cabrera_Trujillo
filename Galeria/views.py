...
def obra(request):
    obra1 = Obra.objects.create(nombre="King Oliver", fecha="1958-01-01", precio=250000)
    obra2 = Obra.objects.create(nombre="Número 16", fecha="1949-01-01", precio=32000000)
    obra3 = Obra.objects.create(nombre="Naranja, rojo y amarillo", fecha="1961-01-01", precio=86500000)
    context = {'obra1': obra1,
               'obra2': obra2,
               'obra3': obra3}
...
def avaluador(request):
    avaluador1 = Avaluador.objects.create(nombre="Mateo Perez", fecha="2022-01-01")
    avaluador2 = Avaluador.objects.create(nombre="Rosario Fuentes", fecha="2021-01-01")
    avaluador3 = Avaluador.objects.create(nombre="Ana Fawk", fecha="2012-01-01")
